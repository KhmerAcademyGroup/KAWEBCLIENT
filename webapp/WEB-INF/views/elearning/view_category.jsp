...
<html lang="en">
    ...
    %>
    <script src="assets/js/script/list_videos_in_category.js"></script>
<script>
		$(document).ready(function() {
			$.post("list_videos_In_categories.act?category="+<%=category%>+"&page="+<%=p%>, {
			}, function(data) {
				$("#list_videos_in_category").html(getJsonListVideosInCategory(data));
			});
		});
</script>
	</head>
