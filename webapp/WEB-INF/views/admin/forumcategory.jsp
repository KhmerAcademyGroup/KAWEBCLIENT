...
<html lang="en">
	...
	<body class="tooltips">
				...
				<div class="container-fluid">
					...
					<div class="the-box no-border">
						...
						<div class="btn-toolbar top-table" role="toolbar">
							<div class="btn-group">
								<form role="form" id="frmSetNumrow">
							...
							<div class="btn-group">
								<a href="addforumcategory.act" class="btn btn-success"><i class="fa fa-plus"></i> Add new category</a>
							</div>
							<div class="btn-group pull-right">
								<form role="form">
									<input type="text" class="form-control" id="tfsearch" placeholder="Search category">
								</form>
								
							</div><!-- /.btn-group .pull-right -->
						</div><!-- /.btn-toolbar top-table -->
						
						<div class="table-responsive" id="getcategories">
		...
		<script src="assets/js/script/forumcategory.js"></script>
		<script>
		$(document).ready(function() {
			$.post("forumcategorypro.act", {
			}, function(data) {
				$("#getcategories").html(getJsonCategories(data));
			});
			$("#frmSetNumrow").change(function(){
				$.post("forumcategorypro.act" , 
						{ 
