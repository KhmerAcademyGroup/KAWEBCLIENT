...
<title>Videos Management | Khmer Academy</title>
...
<body class="tooltips">
	...
	<div class="wrapper">
		...
		<div class="page-content">
			...
			<div class="container-fluid">
				<!-- Begin page heading -->
				<h1 class="page-heading">Video</h1>
				<!-- End page heading -->
				...
				<div class="the-box no-border">
					<div class="btn-toolbar top-table">
						<button type="button" class="btn btn-success"
							onclick="window.location.href='addvideo.act'">
							<i class="fa fa-plus"></i> Add new
						</button>
					</div>

					<div class="table-responsive" id="getvideos"></div>
					<!-- /.table-responsive -->
				</div>
	...
	<script>
		$(document).ready(function() {
			$.post("listvideopro.act", {}, function(data) {
				$("#getvideos").html(getJsonVideos(data));
			});
		});
	</script>
