...
<%@ page import="com.google.gson.*, java.util.ArrayList, model.dto.University" %>

<% 
	 University dto = new University();
	 if(request.getAttribute("university")!=null){ 
			dto = (University) request.getAttribute("University");
		 } %>
...
<html lang="en">
	<head>
		...
		<title>Add University | Khmer Academy</title>
				...
				<br/>				
					<div class="panel panel-primary">
							  <div class="panel-heading">
								<h3 class="panel-title">Form Add University </h3>
							  </div>
					...
					<div>
						<form id="university" name="university" method="post" action="adduniversity.act" class="form-horizontal" role="form">
							<fieldset>
								
								<div class="form-group">
									<label class="col-lg-1 control-label">University Name<span class="required">*</span></label>
									<div class="col-lg-10">
										<input type="text" class="form-control" name="txtUniversity" id="txtUniversity" value="" />
									</div>
									<div class="col-lg-10">
										<input type="hidden" class="form-control" name="txtNumber" id="txtNumber" value="">
									</div>
								</div> 
							</fieldset>
