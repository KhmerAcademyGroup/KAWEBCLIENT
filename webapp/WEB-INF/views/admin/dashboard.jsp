					...
					<div class="row">
						<div class="col-xs-6">
							<div class="tiles facebook-tile text-center">
								...
								<h4>
									<a href="#"><%=request.getAttribute("countalluser") %> Users</a>
								</h4>
							</div>
							<!-- /.tiles .facebook-tile -->
						</div>
						...
						<div class="col-xs-6">
							<div class="tiles twitter-tile text-center">
								...
								<h4>
									<a href="#"><%=request.getAttribute("countallplaylist") %> Playlists</a>
								</h4>
							</div>
							<!-- /.tiles .twitter-tile -->
						</div>
						...
						<div class="col-xs-6">
							<div class="tiles dribbble-tile text-center">
								...
								<h4>
									<a href="#"><%=request.getAttribute("countallquestion") %> Questions</a>
								</h4>
							</div>
							<!-- /.tiles .dribbble-tile -->
						</div>
						...
						<div class="col-xs-6">
							<div class="tiles linkedin-tile text-center">
								...
								<h4>
									<a href="#"><%=request.getAttribute("countallvideo") %> Videos</a>
								</h4>
							</div>
							<!-- /.tiles .dribbble-tile -->
						</div>
