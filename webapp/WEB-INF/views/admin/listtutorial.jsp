...
<html lang="en">
	<head>
		...
		<title>Tutorials | Khmer Academy</title>
					...
					<div class="the-box">
						...
						<table class="table table-striped table-hover" id="datatable-example">
							...
							%>	
								...
								<tr>
									<td><%=i+1%></td>
									<td><%=tutorials.get(i).getTitle() %></td>
									<td><%=tutorials.get(i).getIndex() %></td>
									<td><%=tutorials.get(i).getCategoryname() %></td>
									<td><%=tutorials.get(i).getUsername() %></td>
									<td>
										<button style="margin-right:3px" onclick="deletedata('deletetutorial_pro.act?tutorialid=<%=tutorials.get(i).getTutorialid() %>')" class="btn btn-danger">Delete</button>
										<button onclick="window.location.href='gettutorialpostupdate.act?tutorialid=<%=tutorials.get(i).getTutorialid() %>'" class="btn btn-primary">Update</button>
									</td>
								</tr>
						<%} %>
							</tbody>
