<!DOCTYPE html>
<%@page import="model.dto.ForumCategory"%>
<html lang="en">
	<head>
		<meta charset="utf-8">
	...
	<body class="tooltips">
				...
				<div class="container-fluid">
					...
					<div class="panel panel-primary">
							  <div class="panel-heading">
								<h3 class="panel-title">Form Add Forum Category </h3>
							  </div>
							  <div class="panel-body">
				
					
					
					<div><!-- id="myformvalidator" -->
						<form  method="post" action="addforumcategorypro.act" class="form-horizontal" id="addforumcategory">
							<fieldset>
		...
		<!-- END PAGE CONTENT -->
		<%
			ForumCategory dto=(ForumCategory)request.getAttribute("categorydto");
			if(dto!=null){
		%>
		<script type="text/javascript">
		document.getElementById("categoryid").value="<%=dto.getCategory_id()%>";
		document.getElementById("categoryname").value="<%=dto.getCategory_name()%>";
		document.getElementById("addforumcategory").action="updateforumcategorypro.act";
		</script>
