...
<%@ page import="com.google.gson.*, java.util.ArrayList, model.dto.Category, model.dto.Video" %>
<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="utf-8">
				...
				<br/>				
					<div class="panel panel-primary">
							  <div class="panel-heading">
								<h3 class="panel-title">Form Add Video </h3>
							  </div>
					...
					<div>
						<form id="video" name="video" method="post" action="addvideo_pro.act" class="form-horizontal">
							<fieldset>
								...
								<div class="form-group">
										...
										<div class="col-lg-5">
											<div class="radio">
												<label>
													<input type="radio" name="publicview" id="public" value="1" required="" data-bv-notempty-message="A view is required" data-bv-field="publicview"> Public
												</label>
											</div>
											<div class="radio">
												<label>
													<input type="radio" name="publicview" id="private" checked="checked"> Private
												</label>
											</div>
								...
								<div class="form-group">
									...
									<div class="col-lg-5">
							          <select data-placeholder="Select categories" name="category" id="category" multiple class="chosen-select-width" tabindex="16">
							          <%
