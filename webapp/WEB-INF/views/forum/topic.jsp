...
<html>
	...
	<body class="tooltips">
		...
		<div class="container" >
			...
			<div class="row">
				<div class="col-sm-12 topic" style="margin-bottom:20px">
					<div class="col-sm-12">
						<h3>Topic: This is topic for today talking</h3>
						<span class="small">
							28-Jan-2015 by Sonn Sorady | 168 answer
						</span>
						<hr class="hr-style-one"/>
					</div>
				</div>
				...
				<div class="col-sm-12" style="margin:20px 0px">
					<div class="col-sm-2">
						<img src="assets/img/avatar/avatar-12.jpg" class="img-circle img-responsive center" alt="Avatar">
						<ol class="align-center" style="list-style:none;padding-left:0px;">
							<li>Sonn Sorady</li>
							<li class="small text-danger">Moderator</li>
						</ol>
					</div>
					<div class="col-sm-10">
						<img src="assets/img/topic_arrow.png" class="topic-arrow">
						<div class="topic-box box-shadow">
							This is topic for today talking<br>
							This is topic for today talking<br>
							This is topic for today talking<br>
							This is topic for today talking<br>
							This is topic for today talking<br>
						...
						<span class="small text-muted">28-Jan-2015</span>
					</div>
				</div>
				<div class="col-sm-12" style="margin-bottom:20px">
					<div class="col-sm-2">
						...
						<ol class="align-center" style="list-style:none;padding-left:0px;">
							<li>Vuthea</li>
							<li class="small text-danger">Admin</li>
						</ol>
					</div>
					<div class="col-sm-10">
						<img src="assets/img/topic_arrow.png" class="topic-arrow">
				...
				<div class="col-sm-12" style="margin-bottom:20px">
					<div class="col-sm-2">
						...
						<ol class="align-center" style="list-style:none;padding-left:0px;">
							<li>Chanthy</li>
							<li class="small text-danger">Member</li>
						</ol>
					</div>
					<div class="col-sm-10">
						<img src="assets/img/topic_arrow.png" class="topic-arrow">
