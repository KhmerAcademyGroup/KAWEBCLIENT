	...
	<body class="tooltips no-padding">
		...
		<div class="top-navbar">
			<div class="container">
				...
				<!-- Begin logo -->
				<div class="logo">
					<a href="index.html"><img src="${pageContext.request.contextPath}/resources/assets/img/logo.png" alt="Logo"></a>
				</div><!-- /.logo -->
				<!-- End logo -->
		...
		<script>
			$("#full-img-slide").backstretch([
			  "${pageContext.request.contextPath}/resources/assets/img/image-1.jpg",
			  "${pageContext.request.contextPath}/resources/assets/img/image-3.jpg"
			  ], {
				fade: 750,
				duration: 6000
			});
