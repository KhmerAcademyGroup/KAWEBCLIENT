...
(function () {
        ...
        if (u.tc(a)) {
            ...
            if (e.D)
                if (c) {
                    ...
                    for (g in e.D) c = g, e.D[c] = [], u.kc(a, c)
        }
    };
    u.kc = function (a, c) {
        var d = u.getData(a);
    ...
    u.Player = u.a.extend({
        h: function (a, c, d) {
            ...
            h = setInterval(u.bind(this, function () {
                this.na && (this.na = l, this.userActive(f), clearTimeout(k), k = setTimeout(u.bind(this,
                    function () {
    ...
    t.requestFullscreen = function () {
        var a = u.Na.Bb;
        this.isFullscreen(f);
        a ? (u.d(document, a.qd, u.bind(this, function (c) {
            this.isFullscreen(document[a.fullscreenElement]);
            this.isFullscreen() === l && u.p(document, a.qd, arguments.callee);
            this.k("fullscreenchange")
        })), this.b[a.requestFullscreen]()) : this.g.ab() ? V(this, "enterFullScreen") : (this.td = f, this.kd = document.documentElement.style.overflow, u.d(document, "keydown", u.bind(this, this.qc)), document.documentElement.style.overflow = "hidden", u.o(document.body, "vjs-full-window"),
    ...
    t.va = function () {
        ...
        if (c)
            for (var d = c.length - 1; 0 <= d; d--) a.V(new u.lb(this.m(), {
                rate: c[d] + "x"
            }));
        return a
    };
    ...
    u.f = u.t.extend({
        h: function (a, c, d) {
            ...
            u.t.call(this, a, c, d);
            for (d = u.f.ib.length - 1; 0 <= d; d--) u.d(this.b, u.f.ib[d], u.bind(this, this.md));
            (c = c.source) && this.b.currentSrc === c.src && 0 < this.b.networkState ? a.I(function () {
                a.k("loadstart")
            }) : c && (this.b.src = c.src);
    ...
    t.e = function () {
        var a = this.c,
            c = a.P,
            d;
        if (!c || this.n.movingMediaElementInDOM === l) c ? (d = c.cloneNode(l), u.f.nc(c), c = d, a.P = j) : c = u.e("video", {
            id: a.id() + "_html5_api",
            className: "vjs-tech"
        }), c.player = a, u.Eb(c, a.w());
    ...
    u.i = u.t.extend({
        h: function (a, c, d) {
            ...
            var k = u.l.B({
                ...
                s;
            e && (e.type && u.i.vd(e.type) ?
                (a = u.i.Ic(e.src), k.rtmpConnection = encodeURIComponent(a.wb), k.rtmpStream = encodeURIComponent(a.Rb)) : k.src = encodeURIComponent(u.rc(e.src)));
    ...
    t.va = function () {
        ...
        if (g) {
            e = g.aa;
            for (var k, c = 0, d = e.length; c < d; c++) k = e[c], k = new u.eb(this.c, {
                track: g,
                cue: k
            }), h.push(k), a.V(k)
        }
